...
public class MemberApiController {
    ...
    public CreateMemberResponse saveMemberV2(@RequestBody @Valid CreateMemberRequest request){
        ...
        member.setName(request.getName());//Entity spec이 변경되면 compile error!, api spec에는 영향을 주지 않는다.
        Long id = memberService.join(member);
        return new CreateMemberResponse(id);
    }
    ...
    public  UpdateMemberResponse updateMemberV2(@PathVariable ("id") Long id, @RequestBody @Valid UpdateMemeberRequest request){
    ...
    @Data
    static private class UpdateMemeberRequest {
        private String name;
    }
    ...
    public List<Member> MembersV1(){
        return memberService.findMembers();//Entity를 직접 반환하면 안됨.
    }
        /*
[
  {
